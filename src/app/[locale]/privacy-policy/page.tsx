...
export default async function PrivacyPolicy() {
  const { t } = await getMyTranslation("privacy-policy");

  return (
    <>
      <div className="flex min-h-screen flex-col items-center justify-start bg-gradient-to-b from-blue-50 to-white p-4">
